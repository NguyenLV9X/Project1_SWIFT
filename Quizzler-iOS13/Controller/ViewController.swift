...
class ViewController: UIViewController {
    ...
    @objc func updateUI()
    {
        ...
        answer1Button.setTitle("\(quizBrain.getAnswer1())", for: .normal)
        answer2Button.setTitle("\(quizBrain.getAnswer2())", for: .normal)
        answer3Button.setTitle("\(quizBrain.getAnswer3())", for: .normal)
